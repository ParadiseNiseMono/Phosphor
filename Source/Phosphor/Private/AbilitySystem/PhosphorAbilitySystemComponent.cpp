...
void UPhosphorAbilitySystemComponent::AddCharacterAbilitiesFromSaveData(ULoadScreenSaveGame* SaveData)
{
	for (const FSaveAbility& Data : SaveData->SaveAbilities)
	{
		...
		if (Data.AbilityType == FPhosphorGameplayTags::Get().Abilities_Type_Offensive)
		{
			GiveAbility(LoadedAbilitySpec);
		}
		else if (Data.AbilityType == FPhosphorGameplayTags::Get().Abilities_Type_Passive)
		{
			if (Data.AbilityStatus.MatchesTagExact(FPhosphorGameplayTags::Get().Abilities_Status_Equipped))
			{
